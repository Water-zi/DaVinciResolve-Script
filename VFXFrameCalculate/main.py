...
if __name__ == '__main__':
    ...
    csvDirectory = os.path.join(outputDir, 'Summary_' + projectName + '_' + formatted_date + '.csv')
    xlsDirectory = os.path.join(outputDir, 'Summary_' + projectName + '_' + formatted_date + '.xlsx')
